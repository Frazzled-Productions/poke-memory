...
- `npm run lint` (em-dash + i18n + pseudo-locale + agents-size + marker-lookups) catches errors that do **not** surface in typecheck/build/test, so a hand-run that omits it ships a red PR (#1541).
