...
describe("PwaInstallNudge — locale coverage", () => {
  ...
  it("en: shows nudge heading when visit threshold is met and not dismissed (state in)", async () => {
    ...
    await screen.findByText("Install Poke Memory");
  });
