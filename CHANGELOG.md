...
- **Streak counter** — the home page now shows a pill indicating your current day streak ("N days streak" / "Start your streak!"). The Stats page gains a "Current streak" stat card above the mastery distribution. Reviewing today counts immediately; any missed calendar day resets the streak. Closes [#42](https://github.com/fraserbrookhouse/poke-memory/issues/42).
